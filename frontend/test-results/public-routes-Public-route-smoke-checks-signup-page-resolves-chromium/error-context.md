...
- Name: public-routes.spec.ts >> Public route smoke checks >> signup page resolves
- Location: tests/smoke/public-routes.spec.ts:25:7
...
Locator: getByRole('heading', { name: 'Create your study account' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Create your study account' })
