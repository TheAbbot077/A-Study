...
for event_name in [
    ...
    "teaching_readiness.evaluation_started",
    "teaching_readiness.granted",
    "teaching_readiness.blocked",
    "teaching_readiness.invalidated",
    "teaching_readiness.reevaluation_requested",
    "resource.ready_for_teaching",
    "resource.teaching_readiness_revoked",
    ...
    "self_study.bridge_planning_run.created",
    "self_study.bridge_plan.generated",
    "self_study.bridge_plan.blocked",
    "self_study.bridge_plan.approved",
    "self_study.bridge_plan.rejected",
    "self_study.bridge_plan.activated",
    "self_study.bridge_plan.stale",
    "self_study.bridge_plan.invalidated",
    "self_study.bridge_plan.superseded",
    "self_study.bridge_plan.failed",
    ...
    "self_study.workspace.created",
    "self_study.workspace.updated",
    "self_study.workspace.archived",
    "self_study.workspace.intent_attached",
    "self_study.workspace.intent_completed",
    "self_study.workspace.curriculum_resolved",
    "self_study.workspace.resource_attached",
    "self_study.workspace.resource_status_changed",
    "self_study.workspace.next_action_changed",
    "self_study.workspace.blocked",
    "self_study.workspace.unblocked",
    "self_study.diagnostic_placement_superseded",
]:
